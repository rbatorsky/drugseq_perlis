...
matrix_dir <- "analysis/star/align_trim/Solo.out/Gene/raw/"
...
fwrite(mat, file = "analysis/processed/umi.nondedup.counts.txt", sep = "\t", quote = F, row.names = T, col.names = T)
...
fwrite(mat, file = "analysis/processed/umi.1mm_all_dedup.counts.txt", sep = "\t", quote = F, row.names = T, col.names = T)

# combine with meta data -----
mat = read.table("analysis/processed/umi.1mm_all_dedup.counts.txt")
...
saveRDS(mat_w_genes, "analysis/processed/umi.1mm_all_dedup.counts.rds")


# combine with meta data -----
mat = read.table("analysis/processed/umi.nondedup.counts.txt")
meta = read.xlsx("Drug-Seq_Rd1_Treatment+Barcode.xlsx")
...
saveRDS(mat_w_genes, "analysis/processed/umi.nondedup.counts.rds")
